...
company_file = 'company/com/model_company_processed_2.json'
non_company_file = 'company/personal/model_personal_processed_2.json'
...
for i, lic in enumerate(all_licenses):
    data.extend([(lic, 0)] * company_counts[i])     # 0 表示公司组
    data.extend([(lic, 1)] * non_company_counts[i]) # 1 表示非公司组
